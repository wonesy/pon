 ...
 * @param {number} width Width of hexagon.
 * @param {number} height Height of hexagon.
 * @param {number} sidelength Sidelength of hexagon.
 */
Hexagon = function(x, y, width, height, sidelength) {
    this.Points = [];
    var x1 = null;
    var y1 = null;
...
Hexagon.prototype.draw = function(ctx) {
    ...
    image.onload = function(){
        ctx.drawImage(image, hexX, hexY, hexWidth, hexHeight);
    };
};